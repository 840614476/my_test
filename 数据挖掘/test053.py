...
model.add(Activation("sigmmoid"))                  #sigmoid 二元分类

#模型的编译
model.compile(loss="binary_crossentropy", optimizer="adam", class_mode="binary")     #loss:损失函数（损失方式）  optimizer:求解方法    class_mode:模式
